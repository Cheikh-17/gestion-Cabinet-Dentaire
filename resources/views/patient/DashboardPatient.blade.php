...
<body>
    <h1>je suis dans Dashboard du Patient</h1>
                                    ...
                                    <div class="card border mb-0">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex align-items-center gap-1">
                                                <h5 class="mb-0">3</h5>
                                                <p class="mb-0 text-muted d-flex align-items-center gap-2">invoices
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul class="list-group list-group-flush border-top-0">
                            <li class="list-group-item border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 mx-2">
                                        <h6 class="mb-1">David Jones <span class="text-muted"> - #790841</span>
                                        </h6>
                            ...
                            <li class="list-group-item border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 mx-2">
                                        <h6 class="mb-1">Jenny Jones <span class="text-muted"> - #790841</span>
                                        </h6>
                                        <p class="mb-0 text-primary">$329.20</p>
                                    </div>
                                    <div class="flex-shrink-0">
                            ...
                            <li class="list-group-item border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 mx-2">
                                        <h6 class="mb-1">Jenifer Vintage <span class="text-muted"> -
                                                #790841</span></h6>
                                        <p class="mb-0 text-primary">$329.20</p>
                                    </div>
                                    <div class="flex-shrink-0">
                            ...
                            <li class="list-group-item border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 mx-2">
                                        <h6 class="mb-1">Stebin Ben <span class="text-muted"> - #790841</span>
                                        </h6>
                                        <p class="mb-0 text-primary">$329.20</p>
                                    </div>
                                    <div class="flex-shrink-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2 mt-3 d-flex align-items-center justify-content-between">
                                <h6 class="mb-0 d-flex align-items-center gap-2"><i
                                        class="fas fa-circle text-warning f-12"></i>
                                    Pending</h6>
                                <p class="mb-0 text-muted">$3,202</p>
                            </div>
                            <div class="mb-2 d-flex align-items-center justify-content-between">
                                <h6 class="mb-0 d-flex align-items-center gap-2"><i
                                        class="fas fa-circle text-success f-12"></i>
                                    Paid</h6>
                                <p class="mb-0 text-muted">$45,050</p>
                            </div>
                            <div class="mb-2 d-flex align-items-center justify-content-between">
                                <h6 class="mb-0 d-flex align-items-center gap-2"><i
                                        class="fas fa-circle text-danger f-12"></i>
                                    Overdue</h6>
                                <p class="mb-0 text-muted">$25,000</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 class="mb-0 d-flex align-items-center gap-2"><i
                                        class="fas fa-circle text-primary text-opacity-25 f-12"></i>
                                    Draft</h6>
                        ...
                        <ul class="list-group list-group-flush border-top-0">
                            <li class="list-group-item border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="#!" class="avtar avtar-s btn-link-secondary"><i
